...
LOCAL_SRC_FILES:= $(LOCAL_PATH)/ffmpeg/$(TARGET_ARCH_ABI)/lib/libavcodec.so 
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/ffmpeg/$(TARGET_ARCH_ABI)/include 
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS) 
LOCAL_MODULE:= libavformat 
LOCAL_SRC_FILES:= $(LOCAL_PATH)/ffmpeg/$(TARGET_ARCH_ABI)/lib/libavformat.so 
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/ffmpeg/$(TARGET_ARCH_ABI)/include 
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES:= $(LOCAL_PATH)/ffmpeg/$(TARGET_ARCH_ABI)/lib/libavfilter.so 
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/ffmpeg/$(TARGET_ARCH_ABI)/include
include $(PREBUILT_SHARED_LIBRARY)
